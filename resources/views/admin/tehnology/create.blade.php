...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="h4 mb-0">
            <a href="{{ route('admin.tehnology.index') }}">
                <i class="fas fa-caret-left"></i> @lang('transFront.tehnology')
            </a>
    ...
    <div class="my-4">
        ...
        <form action="{{ route ('admin.tehnology.store') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
