        ...
        <form action="{{ route('admin.about.update', $obj->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="image" class="col-lg-4 col-md-4 col-form-label text-md-right">
                    @lang('transAdmin.image') 1<span class="text-secondary">(364x350)</span>
                </label>
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->img)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("about/admin/".$obj->img) !!}"
                                 alt="{{ $obj->img }}"
            ...
            <div class="form-group row">
                <label for="image_en" class="col-lg-4 col-md-4 col-form-label text-md-right">
                    @lang('transAdmin.image') 2
                    <span class="text-secondary">(541x490)</span>
                </label>
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->image_index)
                    ...
                    <div class="custom-file">
                        <input id="image_en" type="file"
                               ...
                               name="about_index" accept="image/*" onChange="image_enUpload(this);">
            ...
            <div class="form-group row">
                <label for="icon" class="col-lg-4 col-md-4 col-form-label text-md-right">
                    @lang('transAdmin.image') 3 <span class="text-secondary">(410x348)</span>
                </label>
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->icon)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("about/image/".$obj->icon) !!}"
                                 alt="{{ $obj->icon}}"
            ...
            <div class="form-group row">
                <label for="about_banner" class="col-lg-4 col-md-4 col-form-label text-md-right">
                    @lang('transAdmin.image') 4<span>(470x329)</span>
                    <span class="text-secondary"></span>
                </label>
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->image_banner)
                            <img src="{{ Storage::disk('local')->url('about_banner/admin/'.$obj->image_banner) }}"
                    ...
                    <div class="custom-file">
                        <input id="about_banner" type="file"
                               class="custom-file-input {{ $errors->has('image_banner') ? ' is-invalid' : '' }}"
                               name="about_banner" accept="image/*" onChange="image_bannerUpload(this);">
