...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="h4 mb-0">
            <a href="{{ route('admin.vacancy.index') }}">
                <i class="fas fa-caret-left"></i> @lang('transAdmin.vacancy')
            </a>
    ...
    <div class="my-4">
        ...
        <form action="{{ route ('admin.vacancy.update', $obj->id) }}" method="post" enctype="multipart/form-data">
            {!! method_field('PUT') !!}
            {!! csrf_field() !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="mb-3">
                        @if($obj->img)
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("vacancy/admin/".$obj->img) !!}"
                                 alt="{{ $obj->img }}"
