...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            Harydy üýtget
            <a href="{{ route('admin.product.index') }}" class="btn btn-sm btn-secondary pull-right"><i class="fa fa-bars mr-1" aria-hidden="true"></i> Makalalar</a>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route ('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data" class="row">
                ...
                <div class="col-md-6 pb-3">
                    ...
                    <select id="category_id"
                        ...
                        @foreach($categories as $category)
                            <option {{$category->id == $product->category->id  ? 'selected' :''}} value="{{ $category->id }}">{{ $category->getName() }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6 pb-3">
                    ...
                    <input value="{{$product->stars}}" type="number" min="1" max="5" class="form-control" name="stars">
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title_tm" required autofocus value="{{ $product->title_tm }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Mazmuny</label>
                        <textarea name="body_tm" class="form-control summernote" rows="10" required>{{ $product->body_tm }}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Mazmuny (ru)</label>
                        <textarea name="body_ru" class="form-control summernote" rows="10" >{{ $product->body_ru }}</textarea>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="form-group">
                        <label>Düşündirilişi</label>
                        <textarea name="description_tm" class="form-control summernote" rows="10" required>{{ $product->description_tm }}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Düşündirilişi (ru)</label>
                        <textarea name="description_ru" class="form-control summernote" rows="10" >{{ $product->description_ru }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body_en" class="form-control summernote" rows="10" >{{ $product->body_en }}</textarea>
                    </div>
                    <div class="form-group">

                        @lang('transAdmin.description')
                        <textarea name="description_en" class="form-control summernote" rows="10" >{{ $product->description_en }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="mb-3">
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("product/admin/".$product->img) !!}" alt="@lang('transAdmin.not-found')"
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="mb-3">
                            <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("product/admin/".$product->main_img) !!}" alt="@lang('transAdmin.not-found')"
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<input value="{{$product->barcode}}" type="text" name="barcode" class=" form-control">--}}
                    {{--</div>--}}
                    {{--<div class="form-group">--}}
                        {{--<label>@lang('transAdmin.price')</label>--}}
                        {{--<input value="{{(float)$product->price}}" type="number"   name="price" class=" form-control">--}}
                    {{--</div>--}}
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input {{$product->active ? 'checked' : ''}} type="checkbox" class="custom-control-input" id="customControlActive" name="active" value="1">
