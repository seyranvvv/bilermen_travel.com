...
@section('content')
    ...
    <div class="my-4">
        ...
        <form action="{{ route ('admin.service.activity.update', [$service, $obj]) }}" method="post" enctype="multipart/form-data">
            {!! method_field('PUT') !!}
            {!! csrf_field() !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="description_tm"
                              ...
                              name="description_tm" rows="3">{{ $obj->description_tm }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="description_ru"
                              ...
                              name="description_ru" rows="3">{{ $obj->description_ru }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="description_en"
                              ...
                              name="description_en" rows="3">{{ $obj->description_en }}</textarea>
