...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <div class="h3 mb-0">Terjimeler</div>
    </div>
...
<th>Gornusi</th>
 ...
 <td>{!! $obj->slug !!}</td>
                ...
                <td>
                    <a href="{{ route('admin.translations.edit', $obj->id) }}" class="btn btn-outline-success btn-sm mb-1">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-right">
                                    <form action="{{ route('admin.translations.delete', $obj->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
        ...
        @empty
            <tr>
                <td colspan="3" class="text-center bg-light text-secondary">
                    <i class="fas fa-exclamation-circle"></i> Terjimeler @lang('transAdmin.not-found')
                </td>
            </tr>
        @endforelse
        </tbody>
