...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.shopBanner.create') }}" class="btn btn-sm btn-danger">
    ...
    <table class="table shadow table-bordered table-striped table-hover table-md bg-white mt-4">
        ...
        @forelse($objs as $obj)
            <tr>
                <td>{!! $obj->id !!}</td>
                <td>@if($obj->img)
                        <img src="{!! Request::root() !!}{!! Storage::disk('local')->url("shopBanner/admin/".$obj->img) !!}">
                    @else
                ...
                <td>
                    <a href="{{ route('admin.shopBanner.edit', $obj->id) }}" class="btn btn-outline-success btn-sm mb-1">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-right">
                                    <form action="{{ route('admin.shopBanner.delete', $obj->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
        ...
        @empty
            <tr>
                <td colspan="5" class="text-center bg-light text-secondary">
                    <i class="fas fa-exclamation-circle"></i> @lang('transAdmin.baner') @lang('transAdmin.not-found')
                </td>
            </tr>
        @endforelse
        </tbody>
