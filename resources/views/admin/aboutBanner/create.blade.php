...
@section('content')
    ...
    <div class="my-4">
        ...
        <form action="{{ route ('admin.aboutBanner.store') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group row">
                ...
                <select name="type" required class="form-control col-lg-4 col-md-8" id="exampleFormControlSelect1">
                    <option value="about">@lang('transFront.about')</option>
                    <option value="logistics">@lang('transFront.logistics')</option>
                    <option value="advertisement">@lang('transFront.advertisement')</option>
                    <option value="travel">@lang('transFront.travel')</option>
                </select>
            </div>
