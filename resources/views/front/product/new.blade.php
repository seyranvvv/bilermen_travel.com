...
@section('title')@lang('transFront.new-products') | @lang('transFront.app-name')@endsection
@section('keywords')@lang('transFront.new-products')@endsection
@section('image'){!! asset('img/adt.jpg') !!}@endsection
@section('content')
    @component('front.app.breadcrumb')
        <li class="breadcrumb-item active" aria-current="page">
            @lang('transFront.new-products')
        </li>
    @endcomponent
