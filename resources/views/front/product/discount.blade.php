...
@section('title')@lang('transFront.discounts') | @lang('transFront.app-name')@endsection
@section('keywords')@lang('transFront.discounts')@endsection
@section('image'){!! asset('img/adt.jpg') !!}@endsection
@section('content')
    @component('front.app.breadcrumb')
        <li class="breadcrumb-item active" aria-current="page">
            @lang('transFront.discounts')
        </li>
    @endcomponent
