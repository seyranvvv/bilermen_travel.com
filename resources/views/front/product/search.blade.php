...
@section('title')@lang('transFront.search') | @lang('transFront.app-name')@endsection
@section('keywords')@lang('transFront.search')@endsection
@section('image'){!! asset('img/adt.jpg') !!}@endsection
@section('content')
    @component('front.app.breadcrumb')
        <li class="breadcrumb-item active" aria-current="page">
            @lang('transFront.search')
        </li>
    @endcomponent
        ...
        <div class="row">
            <div class="col-12 py-2">
                <div class="d-flex justify-content-between align-items-center text-primary border-bottom py-2">
                    <div class="h5 mb-0">
                        <span class="text-secondary">@lang('transAdmin.search'):</span> {!! $search !!}
                    </div>
